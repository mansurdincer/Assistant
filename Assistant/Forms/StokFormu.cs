...
namespace Assistant.Forms
{
    public partial class StokFormu : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void StokGrupLookUp()
        {
            ...
            colStokGrupId.ColumnEdit = myLookup;
        }
        ...
        private void barButtonItem4_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (dlg == DialogResult.Yes)
            {
                ...
                var count = dbContext.StokDepo.Count(t => t.StokId == stokId);
        ...
        {
            StokTalepFormu form = new StokTalepFormu((int)gridView1.GetFocusedRowCellValue(colId));
            form.ShowDialog();
        }
    }
}
