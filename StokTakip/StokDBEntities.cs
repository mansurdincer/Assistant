...
namespace StokTakip
{
    ...
    public sealed class StokDbEntities : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DepoTur>()
                .Property(e => e.DepoTuru)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<HareketYon>()
                .Property(e => e.HareketYonu)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<StokGrup>()
                .Property(e => e.GrupKod)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<StokTalep>()
                .HasMany(e => e.SatinAlma)
                .WithRequired(e => e.StokTalep)
                .WillCascadeOnDelete(false);
        }
        ...
        public override int SaveChanges()
        {
            ...
            //{
                foreach (var change in modifiedEntities)
                {
                    ...
                    {
                        var originalValue = change.OriginalValues[prop] == null
                            ? string.Empty
                            : change.OriginalValues[prop].ToString();
                        var currentValue = change.CurrentValues[prop] == null
                            ? string.Empty
                            : change.CurrentValues[prop].ToString();
